...
DATABASES = {
    'default': {
        ...
        'NAME': 'device_manager',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'wy9p=y+q*o44!(e4z#^rs4fh2-5tv4w+m!$93qn6#v*3b5%jf5'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'logfile': {
            ...
            'filename': "/home/guilherme/TCC/project/device_manager/logfile",
            'maxBytes': 50000,
            'backupCount': 2,
            'formatter': 'standard',
        },
